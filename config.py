...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Noobcoder-xD/VR-NETWORK-MUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/VRFILES")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/VRxNETWORK")
